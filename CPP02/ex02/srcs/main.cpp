...
static int	testMain( void )
{
    ...
    // Test dei costruttori di copia e assegnamento
    a = Fixed(1234.4321f);

    // Test dell'operatore di inserimento (<<)
    std::cout << "a is " << a << std::endl;
    std::cout << "b is " << b << std::endl;
    std::cout << "c is " << c << std::endl;
    std::cout << "d is " << d << std::endl;

    // Test della conversione a intero e a float
    ...
    // Test degli operatori aritmetici
    Fixed e = b + c;
    Fixed f = b - c;
    Fixed g = b * c;
    Fixed h = b / c;
    ...
    // Test degli operatori di incremento e decremento
    ...
    // Test delle funzioni statiche min e max
